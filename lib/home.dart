...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: const SystemUiOverlayStyle(
        statusBarColor: Color(0xFF4A0D3A), // Morado más oscuro para la barra de estado
  ...
  String _getProductImageUrl(int id) {
    final imageUrls = [
      ...
      // HOME ITEMS (9-18) - Agrega URLs para estos productos
      ...
      // CLOTHING (19-37) - Agrega URLs para estos productos
